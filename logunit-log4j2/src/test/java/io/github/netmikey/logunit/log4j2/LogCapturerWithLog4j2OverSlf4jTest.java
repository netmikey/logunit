...
/**
 * Unit test that uses log4j2 over the slf4j API, applies {@link LogCapturer}s
 * and validates their behavior.
 */
@TestMethodOrder(MethodName.class)
public class LogCapturerWithLog4j2OverSlf4jTest {

    @RegisterExtension
    LogCapturer testLoggerInfoCapturer = LogCapturer.create().captureForType(LogCapturerWithLog4j2OverSlf4jTest.class);
    ...
    private Logger testLogger = LoggerFactory.getLogger(LogCapturerWithLog4j2OverSlf4jTest.class);
