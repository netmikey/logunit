...
public class LogCapturerWithLog4j2Test {
    ...
    @RegisterExtension
    LogCapturer testLoggerInfoCapturer = LogCapturer.create().captureForType(LogCapturerWithLog4j2Test.class);
    ...
    private Logger testLogger = LogManager.getLogger(LogCapturerWithLog4j2Test.class);

    private Logger namedLogger = LogManager.getLogger(LOGGER_NAME);
